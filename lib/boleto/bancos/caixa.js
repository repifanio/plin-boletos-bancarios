...
var Caixa = (function() {
	...
	Caixa.prototype.geraCodigoDeBarrasPara = function(boleto) {
		...
		const dvGeral = true;
		const dvGeralCodBarras = codBarras.calcMod11DvCampoLivre(`104${concat}`, dvGeral);


		const codigoBarrasCompleto = `${banco}${dvGeralCodBarras}${boleto._codigoEspecieMoeda}${fatorVencimento}${valorBoleto.padStart(10, '0')}${campoLivre2}${dvCampoLivre}`;
