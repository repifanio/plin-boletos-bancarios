	...
	GeradorDeBoleto.prototype.gerarPDF = function(args) {
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaLinhaDigitavel + 1)
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaLinhaDigitavel + 1)
					.text(linhaDigitavel, args.ajusteX + 185, args.ajusteY + zeroLinha + 8, {
						lineBreak: false,
						width: 400,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(pagador._registroNacional, args.ajusteX + 465, args.ajusteY + tituloDaPrimeiraLinha - 1, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(pagador._endereco._uf, args.ajusteX + 435, args.ajusteY + tituloDaPrimeiraLinha + 10, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('CEP:', args.ajusteX + 480, args.ajusteY + tituloDaPrimeiraLinha + 11, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(pagador._endereco._cep, args.ajusteX + 500, args.ajusteY + tituloDaPrimeiraLinha + 10, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(9)
					.text('Autenticação Mecânica - Recibo do Pagador', args.ajusteX + 300, args.ajusteY + segundaLinha - 5, {
						lineBreak: false,
						width: 294,
						align: 'center'
					});
