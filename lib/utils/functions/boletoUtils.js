...
var Beneficiario = (function () {
	...
	Beneficiario.prototype.comCodigoNrCedente = function (_nrCedente, _nrCedenteDigito) {
		this._nrCedente = `${_nrCedente}-${_nrCedenteDigito}`;
		console.log(this._nrCedente);
		return this;
	};

	Beneficiario.prototype.getCodigoNrCedente = function () {
		return this._nrCedente;
	};
